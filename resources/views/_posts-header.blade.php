<header class="max-w-xl mx-auto mt-20 text-center">
    ...
    <h2 class="inline-flex mt-2">By Lary Laracore <img src="{{ URL::asset('./images/lary-head.svg') }}" alt="Head of Lary the mascot"></h2>
        ...
        <div class="relative lg:inline-flex bg-gray-100 rounded-xl">
            ...
            <div x-data="{ show: false }" @click.away="show = false">
                <button @click="show = !show" class="py-2 pl-3 pr-9 text-sm font-semibold w-full lg:w-32 text-left flex lg:inline-flex">
                    ...
                    <svg class="transform -rotate-90 absolute pointer-events-none" style="right: 12px; display:inline-flex" width="22" height="22" viewBox="0 0 22 22">
